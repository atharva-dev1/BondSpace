...
async function migrate() {
    console.log('🚀 Starting anonymous chat migration...');
    try {
        ...
        `);
        console.log('✅ Table "anonymous_chats" created.');
        ...
        `);
        console.log('✅ Table "anonymous_messages" created.');
        ...
        `);
        console.log('✅ Table "anonymous_queue" created.');
